...
import SingleAnswerCard from "./SingleAnswerCard.vue";
...
const showLlmAnswer = computed(() => current.value?.kind === "llm-answer");
  ...
  <section class="view scenario-view">
    ...
    <div class="scenario-layout">
      ...
      <article class="scenario-body">
        ...
        <div v-if="(showFactsIntro || showLlmAnswer) && scenario.determination" class="determination">
        ...
        <div class="step-content">
          ...
          <SingleAnswerCard
            v-if="showLlmAnswer && scenario.confidence"

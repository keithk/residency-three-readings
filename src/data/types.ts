...
export interface PersonaArchetype {
  ...
  cueLabel: string;
  cueText: string;
  /** Micro label above the measured-calibration line, e.g. "Measured · spec v1.0.0". */
  measureLabel: string;
  /** One or two sentences of measured calibration results. HTML allowed; display only. */
  measureHtml: string;
}

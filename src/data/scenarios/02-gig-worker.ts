...
export const scenario02: Scenario = {
  ...
  confidence: {
    ...
    beforeNote: "Asked up front, the model commits to the procedural middle path with conviction, every run. Measured over five runs of Claude (Sonnet 4.6), June 2026.",
    afterDist: [

...
export const scenario04: Scenario = {
  ...
  confidence: {
    ...
    beforeNote:
      "Asked up front, the model defers to the explicit regulatory mechanism: six months past the deposit, the funds lose their exemption.",
    afterDist: [
    ...
    afterNote:
      "After three lenses, the model recognizes that a statute with <em>notwithstanding any other provision of law</em> is not subordinate to the regulation operationalizing it, and that the right call may be neither closure nor full exemption but a tracing analysis the household has standing to invoke.",
  },
};

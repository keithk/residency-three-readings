...
export const scenario01: Scenario = {
  ...
  confidence: {
    ...
    beforeNote: "Asked to pick a single answer up front, the model picks the same one and commits, every run. Measured over five runs of Claude (Sonnet 4.6), June 2026.",
    afterDist: [
      { label: "Not in household", value: 40 },
      { label: "In household", value: 17 },
      { label: "Verify further before deciding", value: 43 },
    ],
    afterNote: "After reading through all three lenses, the model surfaces a three-way split. The single 74% became a calibrated <em>I'm not sure, and here's why</em>.",
  },
};

...
**Baseline.** Asked up front, a model typically lands on *Countable as unearned income* with around 81% confidence. Asked up front, the model treats Mom's phone statement as dispositive: no repayment expectation, no loan, count it.

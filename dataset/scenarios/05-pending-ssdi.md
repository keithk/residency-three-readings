...
calibration:
  ...
  baseline_note: "Asked up front, the model commits to the procedural middle: the form exists, the letter doesn't answer its questions, ten days won't hurt."
  target_distribution:
...
**Baseline.** Asked up front, a model typically lands on *Pend for the state medical statement form* with around 86% confidence. Asked up front, the model commits to the procedural middle: the form exists, the letter doesn't answer its questions, ten days won't hurt.

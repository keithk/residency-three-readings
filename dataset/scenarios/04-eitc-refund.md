...
**Baseline.** Asked up front, a model typically lands on *Commingled and countable after six months* with around 84% confidence. Asked up front, the model defers to the explicit regulatory mechanism: six months past the deposit, the funds lose their exemption.

**Target after disaggregation.** Fully exempt under 6409 32, Commingled and countable after six months 30, Trace via lowest intermediate balance 38. After three lenses, the model recognizes that a statute with notwithstanding any other provision of law is not subordinate to the regulation operationalizing it, and that the right call may be neither closure nor full exemption but a tracing analysis the household has standing to invoke.
